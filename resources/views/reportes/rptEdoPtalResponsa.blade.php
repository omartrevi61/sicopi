...
<body>
    <div class="d-flex">
        ...
        <div class="align-items-center d-flex  p-2">
            ...
            <h6>ESTADO PRESUPUESTAL DE PROYECTOS POR RESPONSABLE</h6>
        </div>
    </div>
    ...
    <table class="table table-bordered table-sm small">
        ...
        <tbody>
            ...
            @foreach ($proyectos as $proyecto)
                ...
                @if($proyecto->profesor_id === $m_profesor)
                    
                @else
                    @php
                        $m_profesor = $proyecto->profesor_id;
                    @endphp

                    <tr><th colspan="6">Responable: {{ $proyecto->profesor->grado . ' ' . $proyecto->profesor->nombre . ' ' . $proyecto->profesor->apellidos}}</th></tr>
